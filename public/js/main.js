...
//    eight locations' coordinates
    var locations = [[48.8583701,2.2944813],[48.8737917,2.2950275],[48.8606111,2.337644],[48.8529682,2.3499021],[48.8867046,2.3431043],[48.8599614,2.3265614], [48.8719697,2.3316014],[48.8720718,2.3033057]];

//        info in the pop-up window
    // La tour Eiffel
    var contentString1 = '<div id="marker1">'+'<h3>La tour Eiffel</h3>'+'<img class= "markerImg" src="/img/place1.jpg">'+'<button type="button" class="btn player1 markerBtn" value="1,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+'<img src="/img/uncheck.png">'+' <button type="button" class="btn player2 markerBtn" value="1,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+'<img src="/img/uncheck.png">'+' <button type="button" class="btn player3 markerBtn" value="1,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button>'+'<img src="/img/uncheck.png">'+'</div>';

    // Arc de Triomphe
    var contentString2 = '<div id="marker2">'+'<h3>Arc de Triomphe</h3>'+'<img class= "markerImg" src="/img/place2.jpg">'+'<button type="button" class="btn player1 markerBtn" value="2,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+' <button type="button" class="btn player2 markerBtn" value="2,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+' <button type="button" class="btn player3 markerBtn" value="2,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button>'+'</div>';

    // Museé du Louvre
    var contentString3 = '<div id="marker3">'+'<h3>Museé du Louvre</h3>'+ '<img class= "markerImg" src="/img/place3.jpg">'+'<button type="button" class="btn player1 markerBtn" value="3,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+' <button type="button" class="btn player2 markerBtn" value="3,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+' <button type="button" class="btn player3 markerBtn" value="3,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button> '+'</div>';

    // Notre Dame de Paris
    var contentString4 = '<div id="marker4">'+'<h3>Notre Dame de Paris</h3>'+ '<img class= "markerImg" src="/img/place4.jpg">'+'<button type="button" class="btn player1 markerBtn" value="4,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+' <button type="button" class="btn player2 markerBtn" value="4,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+' <button type="button" class="btn player3 markerBtn" value="4,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button> '+'</div>';

    // Sacré-cœur
    var contentString5 = '<div id="marker5">'+'<h3>Sacré-cœur</h3>'+ '<img class= "markerImg" src="/img/place5.jpg">'+'<button type="button" class="btn player1 markerBtn" value="5,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+' <button type="button" class="btn player2 markerBtn" value="5,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+' <button type="button" class="btn player3 markerBtn" value="5,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button> '+'</div>';

    // Musée d'Orsay
    var contentString6 = '<div id="marker6">'+"<h3>Musée d'Orsay</h3>"+ '<img class= "markerImg" src="/img/place6.jpg">'+'<button type="button" class="btn player1 markerBtn" value="6,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+' <button type="button" class="btn player2 markerBtn" value="6,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+' <button type="button" class="btn player3 markerBtn" value="6,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button> '+'</div>';

    // Opéra Garnier
    var contentString7 = '<div id="marker7">'+'<h3>Opéra Garnier</h3>'+ '<img class= "markerImg" src="/img/place7.jpg">'+'<button type="button" class="btn player1 markerBtn" value="7,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+' <button type="button" class="btn player2 markerBtn" value="7,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+' <button type="button" class="btn player3 markerBtn" value="7,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button> '+'</div>';

    // Place de la Concorde
    var contentString8 = '<div id="marker8">'+'<h3>Warwick Champs-Elysees </h3>'+ '<img class= "markerImg" src="/img/place8.jpg">'+'<button type="button" class="btn player1 markerBtn" value="8,1" onclick="chooseLocation(this)"><img src="/img/player1.png"></button> '+' <button type="button" class="btn player2 markerBtn" value="8,2" onclick="chooseLocation(this)"><img src="/img/player2.png"></button> '+' <button type="button" class="btn player3 markerBtn" value="8,3" onclick="chooseLocation(this)"><img src="/img/player3.png"></button> '+'</div>';
